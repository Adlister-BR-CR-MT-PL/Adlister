...
<<<<<<< Updated upstream:src/main/java/com/codeup/adlister/dao/MySQLAdPicturesDao.java
import java.net.URL;
import java.sql.DriverManager;
...
>>>>>>> Stashed changes:src/main/java/com/codeup/adlister/dao/MySQLAdPicDao.java
